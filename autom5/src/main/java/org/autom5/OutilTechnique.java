...
public class OutilTechnique {
	...
	// Les deux méthodes suivantes sont valables sur cette application mais
	// probablement pas génériques, à cause du faible formalisme des tableaux.
	...
	public static WebElement obtenir_cellule_i_j(WebDriver driver, String xpath_tableau, int i, int j) {
		WebElement cellue_i_j = driver
				.findElement(By.xpath("" + xpath_tableau + "/tbody[2]/tr[" + i + "]/td[" + j + "]"));
		return cellue_i_j;
	}

	public static WebElement obtenir_champ_i_j(WebDriver driver, String xpath_tableau, int i, int j) {
		WebElement champ_i_j = driver
